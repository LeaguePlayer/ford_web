<?php
/**
 * Миграция m130902_090452_car_complecations
 *
 * @property string $prefix
 */
 
class m130902_090452_car_complecations extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{car_complecations}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{car_complecations}}', array(
            'id' => 'pk', // auto increment
			
			'id_car' => "tinyint COMMENT 'Выбрать автомобиль'",
			'title' => "string COMMENT 'Название комплектации'",
