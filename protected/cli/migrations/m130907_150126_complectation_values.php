<?php
/**
 * Миграция m130907_150126_complectation_values
 *
 * @property string $prefix
 */
 
class m130907_150126_complectation_values extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{complectation_values}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{complectation_values}}', array(
            'id' => 'pk', // auto increment
			
			'id_complectation' => "int COMMENT 'Соотвествует комплектации'",
			'id_category_public' => "tinyint COMMENT 'Отображать в кратком обзоре в разделе'",
			'param' => "string COMMENT 'Опция'",
			'value' => "tinyint COMMENT 'Значение опции'",
