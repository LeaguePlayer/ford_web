<?php
/**
 * Миграция m130826_145720_stuff
 *
 * @property string $prefix
 */
 
class m130826_145720_stuff extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{stuff}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{stuff}}', array(
            'id' => 'pk', // auto increment
			
			'image' => "string COMMENT 'Фотография сотрудника'",
			'title' => "string COMMENT 'Фамилия Имя Отчество'",
			'short_desc' => "text COMMENT 'Занимаемая должность'",
