<?php
/**
 * Миграция m130904_033514_partners
 *
 * @property string $prefix
 */
 
class m130904_033514_partners extends CDbMigration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{partners}}', array(
			...
			'title' => "string COMMENT 'Заголовок партнера'",
			'image' => "string COMMENT 'Логотип партнера'",
