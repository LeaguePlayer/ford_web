<?php
/**
 * Миграция m130831_165148_car
 *
 * @property string $prefix
 */
 
class m130831_165148_cars extends CDbMigration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{cars}}', array(
			...
			'title' => "string COMMENT 'Название автомобиля'",
			
			'image' => "string COMMENT 'Изображение автомобиля'",
			'price' => "integer COMMENT 'Стоимость от'",
			
			'video1' => "text COMMENT 'Видео №1 код с youtube'",
			'video2' => "text COMMENT 'Видео №2 код с youtube'",
			'video3' => "text COMMENT 'Видео №3 код с youtube'",
			
			'gallery' => "tinyint COMMENT 'Фотогалерея'",
