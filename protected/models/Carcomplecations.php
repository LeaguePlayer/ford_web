...
/**
 * This is the model class for table "{{car_complecations}}".
 *
 * The followings are the available columns in table '{{car_complecations}}':
 * @property integer $id
 ...
 */
class Carcomplecations extends EActiveRecord
{
	public function tableName()
	{
		return '{{car_complecations}}';
	}
	...
	public static function getComplectations($id_car)
	{
